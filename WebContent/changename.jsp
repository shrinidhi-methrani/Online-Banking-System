...
<head>
    ...
    <script type="text/javascript" src="changenamevalidation.js"></script>
</head>
<body>
    <header class="header">
  ...
  //getting the session with its attributes
    ...
    <div class="wrappershelp">
        <div class="wrapper">
            <form onsubmit="return validation()" action="/BankProject/changenamevalidation" name="change">
                <h1>Change Name</h1>
                <div class="input-box">
                    <input type="text" placeholder="Old Name" name="on" required>
                    <i class='bx bxs-lock-alt'></i>
                </div>
    
                <div class="input-box" id="name">
                    <input type="text" placeholder="New Name" name="nn" required>
                    <i class='bx bxs-lock-alt'></i>
